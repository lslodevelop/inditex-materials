package com.inditex.assets.interfaces.web.exception;

import com.inditex.assets.domain.exception.ApplicationErrorCodes;
import com.inditex.assets.domain.exception.BaseErrorCode;
...
public class HttpErrorStatusResolver {
    ...
    public HttpStatus resolveHttpStatus(final BaseErrorCode baseErrorCode) {
        if (baseErrorCode == ApplicationErrorCodes.NOT_FOUND_ASSET_ERROR) {
